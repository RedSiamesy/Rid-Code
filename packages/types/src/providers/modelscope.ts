...
export const modelScopeModels = {
	...
	"deepseek-ai/DeepSeek-V3.1-Plus": {
		maxTokens: 32_768,
		contextWindow: 131_072,
		supportsImages: true,
		...
		description: `Merge DeepSeek-V3.1 and Qwen2.5-VL-72B-Instruct to grant the Coder model the ability to understand images. Each conversation requires more request counts.`,
	},
