			...
			case "grep":
				if (partialArgs.path !== undefined || partialArgs.regex !== undefined) {
					nativeArgs = {
						...
						after_context: partialArgs.after_context,
						before_context: partialArgs.before_context,
						context: partialArgs.context,
						insensitive_case: partialArgs.insensitive_case,
					}
				}
				break
			case "glob":
				if (partialArgs.path !== undefined || partialArgs.pattern !== undefined) {
					nativeArgs = {
						path: partialArgs.path,
				...
				case "grep":
					if (args.path !== undefined && args.regex !== undefined) {
						nativeArgs = {
							...
							insensitive_case: args.insensitive_case,
						} as NativeArgsFor<TName>
					}
					break
				case "glob":
					if (args.path !== undefined && args.pattern !== undefined) {
						nativeArgs = {
							path: args.path,
