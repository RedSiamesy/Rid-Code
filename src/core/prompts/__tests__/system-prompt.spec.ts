...
describe("SYSTEM_PROMPT", () => {
	...
	it("should include custom mode role definition at top and instructions before markdown rules", async () => {
		...
		// Custom instructions should appear before markdown rules
