...
async function generatePrompt(
	...
	const mcpServersCatalog = isNativeProtocol(effectiveProtocol) ? "" : mcpServersSection

	const toolsCatalog = builtInToolsCatalog + customToolsSection + mcpServersCatalog
