...
IMPORTANT NOTE: After running this tool, you will have no opportunity for further analysis or tool invocation, no chance for regret. You MUST ensure that the user task is completely finished and has a clear result before invoking this tool.

Users won't review the process you used to handle the issue, so please accurately reflect all your conclusions in detail in the "result" of the current tool.
